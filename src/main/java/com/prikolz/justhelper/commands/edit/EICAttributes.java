...
public abstract class EICAttributes {
    ...
    private static HashMap<String, EntityAttribute> attributesMap() {
        ...
        result.put("max_health", EntityAttributes.MAX_HEALTH.value());
        result.put("follow_range", EntityAttributes.FOLLOW_RANGE.value());
        result.put("knockback_resistance", EntityAttributes.KNOCKBACK_RESISTANCE.value());
        result.put("movement_speed", EntityAttributes.MOVEMENT_SPEED.value());
        result.put("attack_damage", EntityAttributes.ATTACK_DAMAGE.value());
        result.put("armor", EntityAttributes.ARMOR.value());
        result.put("armor_toughness", EntityAttributes.ARMOR_TOUGHNESS.value());
        result.put("attack_speed", EntityAttributes.ATTACK_SPEED.value());
        result.put("luck", EntityAttributes.LUCK.value());
        result.put("max_absorption", EntityAttributes.MAX_ABSORPTION.value());
        result.put("gravity", EntityAttributes.GRAVITY.value());
        result.put("entity_interaction_range", EntityAttributes.ENTITY_INTERACTION_RANGE.value());
        result.put("block_interaction_range", EntityAttributes.BLOCK_INTERACTION_RANGE.value());
        result.put("step_height", EntityAttributes.STEP_HEIGHT.value());
        result.put("player_sneaking_speed", EntityAttributes.SNEAKING_SPEED.value());
        result.put("block_break_speed", EntityAttributes.BLOCK_BREAK_SPEED.value());
        result.put("sweeping_damage", EntityAttributes.SWEEPING_DAMAGE_RATIO.value());
        result.put("scale", EntityAttributes.SCALE.value());
        result.put("attack_knockback", EntityAttributes.ATTACK_KNOCKBACK.value());
        result.put("fall_damage_multiplier", EntityAttributes.FALL_DAMAGE_MULTIPLIER.value());
        result.put("safe_fall_distance", EntityAttributes.SAFE_FALL_DISTANCE.value());
        result.put("mining_efficiency", EntityAttributes.MINING_EFFICIENCY.value());
        result.put("submerged_mining_speed", EntityAttributes.SUBMERGED_MINING_SPEED.value());
        result.put("burning_time", EntityAttributes.BURNING_TIME.value());
        result.put("jump_strength", EntityAttributes.JUMP_STRENGTH.value());
        result.put("flying_speed", EntityAttributes.FLYING_SPEED.value());
        result.put("water_movement_efficiency", EntityAttributes.WATER_MOVEMENT_EFFICIENCY.value());
        result.put("tempt_range", EntityAttributes.TEMPT_RANGE.value());
        result.put("spawn_reinforcements", EntityAttributes.SPAWN_REINFORCEMENTS.value());
        result.put("explosion_knockback_resistance", EntityAttributes.EXPLOSION_KNOCKBACK_RESISTANCE.value());
        result.put("oxygen_bonus", EntityAttributes.OXYGEN_BONUS.value());
        result.put("movement_efficiency", EntityAttributes.MOVEMENT_EFFICIENCY.value());
